    ...
    <>
      <div className="row d-flex justify-content-center justify-content-lg-between p-4 m-0">
        <ol className="list-group list-group-light list-group-numbered">
          <div className="fw-bold text-pink border-bottom">ԻՆՉՊԵՍ ՊԱՏՎԻՐԵԼ ԿԱՅՔԻՑ</div>
          ...
          <li className="list-group-item d-flex justify-content-between border-0 align-items-start ">
            <div className="ms-2 me-auto">
              ...
              <div>
                <p className="mb-0">+374 96070445</p>
                <p className="mb-0">+374 95070445</p>
              </div>
            </div>
          </li>
        </ol>
      ...
      <div className="row d-flex justify-content-center justify-content-lg-between p-4 m-0">
        <ol className="list-group list-group-light list-group-numbered">
          <div className="fw-bold text-pink border-bottom">ԱՌԱՔՄԱՆ ՊԱՅՄԱՆՆԵՐԸ</div>
          <li className="list-group-item d-flex justify-content-between border-0 align-items-start">
            <div className="ms-2 me-auto">
		...
		<div className="row d-flex justify-content-center justify-content-lg-between p-4 m-0">
        <ol className="list-group list-group-light list-group-numbered">
          <div className="fw-bold text-pink border-bottom">ՎՃԱՐՄԱՆ ԵՂԱՆԱԿՆԵՐԸ</div>
          <li className="list-group-item d-flex justify-content-between border-0 align-items-start">
            <div className="ms-2 me-auto fw-bold">Կանխիկ՝ անմիջապես պատվերը ստանալու պահին:</div>
          </li>
			 <li className="list-group-item d-flex justify-content-between border-0 align-items-start">
            <div className="ms-2 me-auto fw-bold">Փոխանցում քարտին 4083 0900 1007 3610 (կարող եք փոխանցում կատարել ապրանքը ստանալու պահին,ձեր հեռախոսի օն լայն հավելվածի միջոցով):</div>
          </li>
        </ol>
      </div>
